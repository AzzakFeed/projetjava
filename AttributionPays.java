public class AttributionPays {
	...
	Pays p20=new Pays(20,"Alaska",1);
	Pays p21=new Pays(21,"Afghanistan",1);
	Pays p22=new Pays(22,"Afrique du Nord",1);
	Pays p23=new Pays(23,"Afrique du Sud",10);
	Pays p24=new Pays(24,"Afrique Orientale",10);
	Pays p25=new Pays(25,"Alaska",1);
	Pays p26=new Pays(26,"Afghanistan",1);
	Pays p27=new Pays(27,"Afrique du Nord",1);
	Pays p28=new Pays(28,"Afrique du Sud",10);
	Pays p29=new Pays(29,"Afrique Orientale",10);
	Pays p30=new Pays(30,"Alaska",1);
	Pays p31=new Pays(31,"Afghanistan",1);
	Pays p32=new Pays(32,"Afrique du Nord",1);
	Pays p33=new Pays(33,"Afrique du Sud",10);
	Pays p34=new Pays(34,"Afrique Orientale",10);
	Pays p35=new Pays(35,"Alaska",1);
	Pays p36=new Pays(36,"Afghanistan",1);
	Pays p37=new Pays(37,"Afrique du Nord",1);
	Pays p38=new Pays(38,"Afrique du Sud",10);
	Pays p39=new Pays(39,"Afrique Orientale",10);
	Pays p40=new Pays(40,"Alaska",1);
	Pays p41=new Pays(41,"Afghanistan",1);
	Pays p42=new Pays(42,"Afrique du Nord",1);
